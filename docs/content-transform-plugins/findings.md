...
<div class="ratio ratio-16x9">
  <iframe src="//www.youtube.com/embed/{CODE}" frameborder="0" width="640" height="360" allowfullscreen></iframe>
</div>
```
...
<div class="ratio" style="--bs-aspect-ratio: 177.78%; max-width: 360px">
  <iframe src="//www.youtube.com/embed/{CODE}" frameborder="0" width="360" height="640" allowfullscreen></iframe>
</div>
```

### Instagram
```html
<blockquote class="instagram-media" data-instgrm-captioned data-instgrm-permalink="https://www.instagram.com/{TYPE}/{CODE}" data-instgrm-version="14"></blockquote>
