<script lang="ts">
    ...
    import WidgetDetailsPanel from './components/widget-details-panel.svelte';
    import AddWidgetDialog from './components/add-widget-dialog.svelte';
    import ZoneTabs from './components/zone-tabs.svelte';
    import WidgetUploader from '$lib/components/widget-uploader.svelte';
    ...
    async function loadInstalledWidgets() {
        ...
        try {
            const response = await fetch('http://localhost:5173/api/widgets');
    ...
    async function deleteWidget(widgetId: string, widgetName: string) {
        ...
        try {
            const response = await fetch(`http://localhost:5173/api/widgets/${widgetId}`, {
                method: 'DELETE'
            });
