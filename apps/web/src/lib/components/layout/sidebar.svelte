...
<div
    ...
    class="group flex h-full flex-col py-2 pe-3 data-[collapsed=true]:py-2"
>
    <!-- 메뉴 영역 (스크롤 가능) -->
    <div class="flex-1 space-y-4 overflow-y-auto overscroll-contain">
    ...
    <!-- 사이드바 하단 고정 광고 (aside가 viewport 높이 고정이므로 shrink-0으로 항상 노출) -->
    <div class="shrink-0 space-y-2 px-2 pt-2">
