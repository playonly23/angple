<script lang="ts">
    ...
    async function handleSave() {
        ...
        try {
            if (editingGroup) {
                await fetch(`/api/admin/board-groups/${editingGroup.id}`, {
                    method: 'PUT',
                ...
                await fetch('/api/admin/board-groups', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({
                        id: formId,
    ...
    async function deleteGroup(group: BoardGroup) {
        ...
        try {
            await fetch(`/api/admin/board-groups/${group.id}`, {
                method: 'DELETE'
            });
            await fetchGroups();
        } catch (err) {
    ...
    async function moveGroup(index: number, direction: 'up' | 'down') {
        ...
        try {
            await fetch('/api/admin/board-groups/reorder', {
                method: 'PATCH',
                headers: { 'Content-Type': 'application/json' },
