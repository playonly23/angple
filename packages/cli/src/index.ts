...
const create = program.command('create').description('새 테마, 플러그인, 위젯을 생성합니다');
...
create
    ...
    .option(
        '-t, --type <type>',
        '플러그인 타입 (board, editor, seo, ai, auth, media, social, analytics, custom)',
        'custom'
    )
...
create
    ...
    .option(
        '-c, --category <category>',
        '위젯 카테고리 (content, sidebar, ad, social, utility)',
        'sidebar'
    )
